...
RSpec.describe "Api::V2::ShoppingBaskets::ShoppingBasketProducts", type: :request do
  let(:product) { create(:product, stock: 10) }
  let(:base_url) { "/api/v2/shopping_basket/products" }
  ...
  describe "POST /api/v2/shopping_basket/products" do
